...
{user?._id === data?._id ? (<LiaEditSolid size={22}
                                          className='text-blue cursor-pointer'
                                           onClick={()=>dispatch(UpdataProfile(true))}
/>):(  
...
<span>{user?.location ?? "Add Location"}</span>
 ...
 <div  className='flex gap-2 items-center text-ascent-2'>
 <BsBriefcase className='text-xl text-ascent-2'/>
...
<p  className='text-xl text-ascent-2 font-semibold'>{user?.friends?.length} Friends</p>
...
<div className='flex gap-2 items-center text-ascent-2'><BsInstagram  className='text-xl text-ascent-1'/>
<span>Instagram</span>
 </div>
 <div className='flex gap-2 items-center text-ascent-2'><FaFacebook  className='text-xl text-ascent-1'/>
<span> Facebook</span>
 </div>

 <div className='flex gap-2 items-center text-ascent-2'><FaSquareXTwitter  className='text-xl text-ascent-1'/>
<span> X</span>
 </div>
